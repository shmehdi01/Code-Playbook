...
### 2.2.2 String Constants, Naming, and Values
...
Use __7 space__ indents for line wraps:
...
Color names start with a prefix `color`. For example `colorRed`.
...
### References:
* [Code Style for Contributers](https://source.android.com/source/code-style)
* [Ribot Android Style Guide](https://github.com/ribot/android-guidelines/blob/master/project_and_code_guidelines.md)
...
* [Android Resources naming Cheat Sheet](http://jeroenmols.com/img/blog/resourcenaming/resourcenaming_cheatsheet.pdf)

#### Maintainers:

Prinsu Kumar, Ashutosh Singh